    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                    data-target="#navbar-collapse-top-menu">
            ...
            <ul class="nav navbar-nav">
                @unless (Auth::guest())
                    @unless (Auth::user()->userGroup->id==\App\UserGroup::COMMUNITY_USER)
                        <li @if (Request::is('lead') || Request::is('lead/*')) class="ui-state-default" @endif><a
                                    href="/lead">Leads</a></li>
                    @endunless
                    <li @if (Request::is('contact') || Request::is('contact/*')) class="ui-state-default" @endif><a
                                href="/contact">Contacts</a></li>
                    <li @if (Request::is('account') || Request::is('account/*')) class="ui-state-default" @endif><a
                                href="/account">Accounts</a></li>
                    <li @if (Request::is('opportunity') || Request::is('opportunity/*')) class="ui-state-default" @endif>
                        <a href="/opportunity">Opportunities</a></li>
                    <li @if (Request::is('report') || Request::is('report/*')) class="ui-state-default" @endif><a
